...
class HeaderItem extends StatefulWidget {
  const HeaderItem(GlobalKey<ScaffoldState> scaffoldKey, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      ...
      if (constrains.maxWidth >= 1200) {
        print('big screen');
        return Padding(
          padding: const EdgeInsets.fromLTRB(80.0,25.0,80.0,25.0),
          child: Row(
      ...
      //Tablet
      if (constrains.maxWidth > 480 && constrains.maxWidth < 1400) {
        return Padding(
